...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="<c:url value="/utilisateur/creer" />"><span class="glyphicon glyphicon-user"></span> S'inscrire</a></li>
      <li><a href="<c:url value="/utilisateur/modifier" />"><span class="glyphicon glyphicon-log-in"></span> S'identifier</a></li>
